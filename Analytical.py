...
np.savez(
    ...
    spheres=spheres,       # NEW (shape: [Ns, 4] with columns x,y,z,r in mm)
    c=c,                   # NEW (mm/us)
    B=B,                   # optional, defaults to 1.0 in the new script
    Cp=Cp                  # optional, defaults to 1.0 in the new script
)
